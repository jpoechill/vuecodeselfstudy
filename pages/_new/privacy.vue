<template>
    <div class="pages-wrapper">
      <div class="container">
        <div class="row pages-row-padding">
          <div class="col-md-12">
            <p class="pages-header-padding">
              <span class="pages-header-text">
                Privacy
              </span>
            </p>
            <p class="pages-row-body">
            ...
            <p class="pages-row-body">
              ...
              If at any time you would like to unsubscribe from receiving future emails, you can email us at contact@codeselfstudy.com and we will promptly remove you from ALL correspondence.
            </p>
            <p class="pages-header-padding">
              <span class="pages-header-text">
                Contacting Us
            ...
            <p class="pages-row-body">
              ...
              <br><br>
              CodeSelfStudy.com <br>
              El Sobrante USA <br>
              P.O. Box 20311 <br>
              California 94803 <br><br>
              Email: contact@codeselfstudy.com <br>
              Phone: 413-306-4433
            </p>
          </div>
        </div>
